...
debugger.preview_table("config_database", limit=10)
debugger.preview_table("email_list", limit=10)
debugger.preview_table("people_database", limit=10)
debugger.preview_table("timesheet_database", limit=10)